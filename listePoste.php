                ...
                <div class="card height-auto">
                    ...
                    <a href="index.php">   <button class="btn btn-primary btn-lg">DECONNEXION</button></a>
                        <div class="heading-layout1">
                            ...
                            <a href="poste.php" class="btn btn-primary" style = "height: 50px; width:50px;" ><img  src="plus.png" alt=""></a>
                        ...
                        <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                        <?php
                                            ...
                                            $table = "poste"; 
                                            $fetchPoste = $database->getReference($table)->getValue();
                                            if($fetchPoste > 0) 
                                            {
                                                $i=0; 
                                                foreach($fetchPoste as $key => $row)
                                                {
                                                    $i++; 
                                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                  ...
                                                  <input type="hidden" name="id_key3" value="<?=$key; ?>">
                                                  <button type="submit" class="btn btn-danger btn-lg" name="deletePoste">Delete</button>
                                                  </form>                                                                  
                                                    
                                            </div>
                                        </td>
                                        <td>
                                        <a href="modifPoste.php?id=<?= $key; ?>" > <button class="btn btn-primary btn-lg">Update</button></a>
                                        </td>
