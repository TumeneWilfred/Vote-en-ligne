                        ...
                        <form class="new-added-form" action="code2.php" method="POST">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="nom du poste" name="nomPoste" class="form-control" required>
                               <br>
                                </div>
                            ...
                            <br>
                            <button class="btn btn-primary btn-lg btn-lg" name="creerPoste">CREER</button>
