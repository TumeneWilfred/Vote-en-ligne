                        ...
                        <form class="new-added-form" action="code.php" method="POST">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Entrer le nom de votre nom de votre élection </label>
                                    <input type="text" placeholder="nom de l'élection" name="nomElection" class="form-control" required>
                               <br>
                                </div>
                                
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label> Spécifiez le temp de votre  l'élection</label>
                                    <input type="number" placeholder="tempElection" name="tempElection" class="form-control" require>
                                </div>
                               
                               
                            </div>
                            <br>
                            <button class="btn btn-primary btn-lg btn-lg" name="creerElection">CREER</button>
