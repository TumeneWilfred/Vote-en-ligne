                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" action="code.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Filiere *</label>
                                    <select class="select2" name="filiere">
                                        <option value=""></option>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="Matricule" name = "matricule" class="form-control air-datepicker"
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Niveau</label>
                                    <input type="number" name="niveau" placeholder="Niveau" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Departement *</label>
                              
                                    <select class="select2" name="departement">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg" name = "enregistrer">Enregistrer</button>
